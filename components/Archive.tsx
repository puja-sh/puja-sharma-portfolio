  ...
  return (
    <div className="max-w-contentContainer mx-auto px-4 py-24">
      <div className="w-full flex flex-col items-center">
        ...
        <p className="text-sm font-titleFont text-primaryColor">
          view the archive
        </p>
      </div>
      ...
      <div className="mt-12 flex items-center justify-center">
        {showMore ? (
          <button
            ...
            className="w-36 h-12 rounded-md text-primaryColor text-[13px] border border-primaryColor hover:bg-hoverColor duration-300"
          >
            Show Less
          </button>
        ) : (
